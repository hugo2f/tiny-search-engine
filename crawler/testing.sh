...
./crawler arg
# bad seedURL, pageDirectory, maxDepth
# TODO / at the end of url
./crawler http://www.4399.com/ ../data 1
...
valgrind --leak-check=full --show-leak-kinds=all ./crawler http://cs50tse.cs.dartmouth.edu/tse/toscrape/ ../data/valgrind 0
